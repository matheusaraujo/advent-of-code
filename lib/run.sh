...
run_part() {
    ...
    #     lib/python/run.sh $year $day $part "$input_file" "$output_file"
    # done
    ...
    if [ -f "$year/day$day/data/output.$part.txt" ]; then
        ...
        lib/python/run.sh $year $day $part "$year/day$day/data/input.txt"  "$year/day$day/data/output.$part.txt"
    else  
        #lib/perl/run.sh $year $day $part "$year/day$day/data/input.txt"
        lib/python/run.sh $year $day $part "$year/day$day/data/input.txt"
    fi
}
