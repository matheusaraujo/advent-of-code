...
def main():
    ...
    execute_part(part_name, input_file, part1 if part_name == "part1" else part2, input_data, expected_output)

def read_file(file_path: Optional[str], single_line: bool = False) -> Optional[List[str]]:
    if not file_path:
        return None
...
def execute_part(part_name: str, input_file: str, part_function, input_data: List[str], expected_output: Optional[str]):
